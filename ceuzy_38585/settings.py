"""
Django settings for ceuzy_38585 project.
...
WSGI_APPLICATION = 'ceuzy_38585.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "ceuzy_38585 API",
    "DESCRIPTION": "API documentation for ceuzy_38585 App",
    "VERSION": "v1",
}
